...
#define BUT_1_LEV    0
#define BUT_1_PULL   0
#define BUT_1_EVENT  (BUT_EV_PRESSED | BUT_EV_HELD)
//UP
#define BUT_2_ID     2
#define BUT_2_DDRX   DDRA
#define BUT_2_PORTX  PORTA
#define BUT_2_PINX   PINA
#define BUT_2_PIN    1
#define BUT_2_LEV    0
#define BUT_2_PULL   0
#define BUT_2_EVENT  (BUT_EV_PRESSED | BUT_EV_HELD)
//ENT
#define BUT_3_ID     3
#define BUT_3_DDRX   DDRA
#define BUT_3_PORTX  PORTA
#define BUT_3_PINX   PINA
#define BUT_3_PIN    4
#define BUT_3_LEV    0
#define BUT_3_PULL   0
...
// ESC
#define BUT_4_ID     4
#define BUT_4_DDRX   DDRA
#define BUT_4_PORTX  PORTA
#define BUT_4_PINX   PINA
#define BUT_4_PIN    5
#define BUT_4_LEV    0
#define BUT_4_PULL   0
